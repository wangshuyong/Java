...
//    		  var jsonParam = JSON.stringify(aoData);
				...
				{mDataProp: null, "sDefaultContent": "<button id='delete' href='../admin/User_delete' value='shanchu'></button>", "bSortable": false }
                ]
            });

//<a class='edit' id='delet href='../admin/User_edit?userId=id'>删除</a>
			 var nEditing = null;
				...
				$.ajax({ 
					...
					cache: false, 
					 success: function (result) { 
					  location.href ="../admin/User_edit.html"; 
					} 
				});
			});**/
        }
