...
<link rel="stylesheet" type="text/css"
	href="http://localhost:8080/pycms/files/css/tab-main.css">
...
<body>
	<div id="wrapper" data-static="http://localhost:8080/pycms/files/"
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li class="active"><a href="#"><i class="fa fa-columns fa-fw"></i>
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">主Tab管理</div>
						<!-- /.panel-heading -->
								...
								<form class="form-list">
									<div class="input-group">
										<span class="input-group-addon">ID</span> <input
											class="form-control" type="text" id="tab-main-id">
									</div>
									<div class="input-group">
										<span class="input-group-addon">名称</span> <input
											class="form-control" type="text" id="tab-main-title">
									</div>
									<div class="input-group">
										<select class="form-control" id="tab-main-type">
											<option value="">对应角色</option>
											<option value="教师版">教师版</option>
											<option value="家长版">家长版</option>
											<option value="校长版">校长版</option>
										</select>
									</div>
								</form>
								<div class="col-lg-12">
									<table id="tab-main-table"
										...
										<tbody>
											...
											<tr class="items" data-id="10">
												<td>101</td>
												<td class="title">资讯动态</td>
												<td>家长版</td>
												<td>测试</td>
												<td>2015-05-25 11:39:13</td>
												<td class="table-edit"><a class="btn-edit"><span
														title="编辑" class="fa fa-pencil"></span>
												</a></td>
											</tr>
											<tr class="items" data-id="11">
												<td>102</td>
												<td class="title">学校</td>
												<td>家长版</td>
												<td></td>
			...
			<!-- /.row -->
			<div class="modal fade tab-main-edit-modal" role="dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<input class="form-control" maxlength="4" type="text"
								id="tab-title" placeholder="Tab名称">
						</div>
	...
	<script type="text/javascript"
		src="http://localhost:8080/pycms/files/js/tab-main.js"></script>
</body>
</html>