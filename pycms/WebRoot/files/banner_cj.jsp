...
<body>
	<div id="wrapper" data-static="http://localhost:8080/pycms/files/"
		...
		<div id="page-wrapper" data-role="school_admin" data-type="banner"
			data-is-banner="1">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="banner-area">
						<div id="form-8">
							<label class="col-sm-2 control-label">Banner有效期</label>
							<div class="input-group">
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-calendar"></i> </span> <input type="text"
									class="form-control" id="banner-end-time">
							</div>
						</div>
						<div id="form-7">
							<label class="col-sm-2 control-label">Banner图片</label> <span
								class="btn btn-default fileinput-button"> <i
								class="glyphicon glyphicon-plus"></i> <span>上传图片</span> <input
								id="banner-image-upload" type="file" name="file"
								multiple="multiple"> </span>
							<p>图片尺寸限制分辨率310x720 只支持png、jpg、jpeg、gif文件</p>
						</div>
						<ul id="banner-file"></ul>
					</div>
					<!-- btn-heading end -->
						...
						<div class="panel-body">
							<div>
								<ul class="list">
									...
									<li class="vote"><a href="#vote">发送投票</a></li>
									<li class="survey"><a href="#survey">发送问卷</a></li>
									<li class="survey-tpl"><a href="#survey-tpl">问卷模板库</a></li>
								</ul>
								<div class='forms'>
									<div class="notice list-1">
										<div id="form-1">
											<label class="col-sm-2 control-label">标题</label> <input
										...
										<div id="form-4">
											...
											<div class="input-group">
												<span class="input-group-addon"><i
													...
													type="text" class="form-control" id="notice-intended-time"
													value="">
											</div>
										</div>
										<div id="form-live-end-time" class="notice-live-show"
											...
											<div class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-calendar"></i> </span> <input
													type="text" class="form-control" id="notice-live-end-time"
													value="">
											</div>
										</div>
										<div id="form-5">
                                            ...
                                            <input id="homework-title" class="form-control" type="text">
												...
												<div class="form-group" id='homework-wcsj'>
													...
													<div class="input-group">
														<span class="input-group-addon"><i
															class="glyphicon glyphicon-calendar"></i> </span> <input
															type="text" class="form-control" id="homework-deadline"
															value="2015-11-20 08:00">
													</div>
												</div>
												<div class="form-group">
													<label>定时发送</label>
													<div class="input-group">
														<span class="input-group-addon"><i
															class="glyphicon glyphicon-calendar"></i> </span> <input
															type="text" class="form-control" id="homework-send-time"
															value="">
													</div>
												</div>
												<div class="form-group">
									...
									<div class="vote list-2">
										...
										<div class="time-area">
											...
											<div class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-calendar"></i> </span> <input
													type="text" class="form-control" id="vote-start-date"
													value="2015-11-19 18:00">
											</div>
											<span>&nbsp;至</span>
											<div class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-calendar"></i> </span> <input
													type="text" class="form-control" id="vote-end-date">
											</div>
											<br>
										</div>
									...
									<div class="survey list-3">
										...
										<div class="time-area">
											...
											<div class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-calendar"></i> </span> <input
													type="text" class="form-control" id="survey-start-date"
													value="2015-11-19 18:00">
											</div>
											<span>&nbsp;至</span>
											<div class="input-group">
												<span class="input-group-addon"><i
													class="glyphicon glyphicon-calendar"></i> </span> <input
													type="text" class="form-control" id="survey-end-date">
											</div>
											<br>
										</div>
											...
											<table id="survey-table"
												...
												<tbody>
													<tr class="items" data-id="80">
														...
														<td>尊敬的各位家长、同学： ...</td>
														<td><a class="choose-survey">选择该模板</a></td>
													</tr>
