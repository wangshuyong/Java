...
<meta name="keywords" content="${sitetype}">
<meta name="description" content="${sitetype}">
<title>${sitetype}|网站/网页制作教程-海乐网</title>
		...
		<div id="body_article" align="left">
			<div id="list_info">
				<div align="left" id="list_info_row_title">
						...
						${sitetype}&nbsp; <span class="STYLE4">&gt;&gt;</span> 列表</span></li>
...
<#list clInfos as clInfos>
		...
		<div align="left" id="list_info_row_content">
			...
			&nbsp;&nbsp;&nbsp;<span class="STYLE8">&nbsp;</span>
			<#if clInfos.is_show?length lt 90>
			${clInfos.is_show}
			<#else>
			${clInfos.is_show[0..89]}
			</#if>
