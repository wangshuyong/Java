...
<body>
<table width="98%" align="center" border="0" cellpadding="0" cellspacing="1" bgcolor="#799ae1">
  <form name="frm" action="listsiteinfo.shtml" method="request">
	
  <tr bgcolor="#FFFFFF" class="row_bottom">
    <td height="22" width="8%" align="center"><strong><a href="#" onClick="return buildmore();">发布选中</a></strong></td>
    <td height="22" align="center" width="36%"><strong>标题</strong></td>
    <td align="center" width="11%"><a href="#" onClick="if(window.confirm('你确定发布列表页吗')) this.href='buildlisthtml.shtml?type=<bean:write name="filetype"/>';"><B>发布列表</B></a></td>
