...
<logic:iterate id="infolist" name="clInfos" indexId="idx">
  <tr bgcolor="#FFFFFF" height="25"  onMouseOver="this.bgColor='#ced7f7';" onMouseOut="this.bgColor='#FFFFFF';">
	...
	<td width="10%" align="center">&nbsp;<bean:write name="infolist" property="is_show"/></td>
    <td width="10%" align="center">&nbsp;</td>
    <td align="center">&nbsp;<a href="editsiteinfo.shtml?id=<bean:write name="infolist" property="id"/>">编辑</a></td>
    <td align="center">&nbsp;
