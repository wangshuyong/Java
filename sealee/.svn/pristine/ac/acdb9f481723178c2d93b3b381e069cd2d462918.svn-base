...
<form name="frm" action="listsiteinfo.shtml" method="post">
  ...
  <tr bgcolor="#FFFFFF" class="row_bottom">
    <td height="22" width="8%" align="center"><strong><a href="#" onClick="return buildmore();">列表</a></strong></td>
    <td height="22" align="center" width="36%"><strong>标题</strong></td>
    <td align="center" width="11%"><a href="#" onClick="if(window.confirm('你确定发布列表页吗')) this.href='buildlisthtml.shtml?filetype=<bean:write name="type"/>';"><B>生成页面列表</B></a></td>
...
<logic:iterate id="infolist" name="clInfos" indexId="idx">
  <tr bgcolor="#FFFFFF" height="25"  onMouseOver="this.bgColor='#ced7f7';" onMouseOut="this.bgColor='#FFFFFF';">
    ...
    <td width="11%" align="center"><a href="#" onClick="if(window.confirm('你确定删除吗')) this.href='buildhtml.shtml?id=<bean:write name="infolist" property="id"/>&filetype=<bean:write name="infolist" property="filetype"/>';">生成</a></td>
	...
	<a href="#" onClick="if(window.confirm('你确定审核吗')) this.href='viewinfo.shtml?id=<bean:write name="infolist" property="id"/>"><font color="#FF0000" >审核</font></a>	</logic:notEqual>
	<logic:equal name="infolist" property="remark" value="1">
	<a href="#" onClick="if(window.confirm('你要取消审核吗')) this.href='viewnotinfo.shtml?id=<bean:write name="infolist" property="id"/>">取消</a>	</logic:equal>	</td>
    <td align="center">&nbsp;<a href="siteinfo.shtml?id=<bean:write name="infolist" property="id"/>">编辑</a></td>
    <td align="center">&nbsp;
	<a href="#" onClick="if(window.confirm('你确定删除吗')) this.href='deletesiteinfo.shtml?id=<bean:write name="infolist" property="id"/>';">删除</a></td>
  </tr>
 </logic:iterate>
