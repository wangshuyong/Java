...
<table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#799ae1">
  ...
  <tr bgcolor="#FFFFFF" class="row_bottom">
    ...
    <td height="22" align="center" width="20%"><strong>标题</strong></td>
    <td align="center" width="10%"><strong>发布列表</strong></td>
    <td align="center" width="10%"><strong>作者</strong></td>
    <td align="center" width="10%"><strong>精华</strong></td>
...
<logic:iterate id="infolist" name="clInfos" indexId="idx">
  <tr bgcolor="#FFFFFF" height="25"  onMouseOver="this.bgColor='#ced7f7';" onMouseOut="this.bgColor='#FFFFFF';">
    ...
    <td width="10%" align="center">&nbsp;<bean:write name="infolist" property="author"/></td>
	<td width="6%" align="center">&nbsp;
	<logic:equal name="infolist" property="is_show" value="1">是</logic:equal></td>
    
    <td align="center">&nbsp;<a href="editsitetype.shtml?id=<bean:write name="infolist" property="id"/>">编辑</a></td>
    <td align="center">&nbsp;
