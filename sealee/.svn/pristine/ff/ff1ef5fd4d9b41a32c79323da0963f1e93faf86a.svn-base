...
<logic:iterate id="usrlist" name="clInfos" indexId="idx">
  <tr bgcolor="#FFFFFF" height="25"  onMouseOver="this.bgColor='#ced7f7';" onMouseOut="this.bgColor='#FFFFFF';">
    ...
    <td width="20%">&nbsp;&nbsp;
	<bean:write name="usrlist" property="username"/></td>
    <td width="10%" align="center">&nbsp;
    <bean:write name="usrlist" property="password"/></td>
	<td width="10%" align="center">&nbsp;<bean:write name="usrlist" property="admin_power"/></td>
    <td width="10%" align="center">&nbsp;</td>
    <td align="center">&nbsp;<a href="userinfo.shtml?id=<bean:write name="usrlist" property="id"/>">编辑</a></td>
    <td align="center">&nbsp;
	<a href="#" onClick="if(window.confirm('你确定删除吗')) this.href='deleteuser.shtml?id=<bean:write name="usrlist" property="id"/>';">删除</a></td>
  </tr>
 </logic:iterate>
