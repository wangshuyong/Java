...
public class MemberNewInformationAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(infoForm.getContent()!=null&&!infoForm.getContent().equals("")&&infoForm.getTitle()!=null&&!infoForm.getTitle().equals("")){
			...
			if(infoForm.getAuthor()!=null&&!infoForm.getAuthor().equals("")){
				memberDAO.doUpdateIntegral(infoForm.getAuthor());
			}
		}
