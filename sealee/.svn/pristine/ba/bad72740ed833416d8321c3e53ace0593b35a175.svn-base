...
<TR>
	<TD>编辑内容：</TD>
	<TD>
		<INPUT type="hidden" name="content1" value="<p>&nbsp;</p><p><font color=#ff0000>本样式为自带默认样式，最佳调用宽度650px，高度350px！</font></p><p>下面为一些高级调用功能的例子，你可以用脚本方便的编辑进行一些操作。</p><p>看到这些内容，且没有错误提示，说明安装已经正确完成！</p><p>您现在使用的是飞鱼修改版，有什么问题请到http://www.ITstudy.cn提出！</p>">
