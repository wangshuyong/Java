...
<%@ page import="com.model.TSiteInformation"%>
...
-->
 ...
 //-->
 function buildmore() {
	if (document.getElementById('test[]').checked==0) {
		alert("请先选择信息，然后再发布。");
		return false;
	}
	if (confirm('是否确定发布选择的任务？'))
	{
		frm.submit();
	}
}
...
<form name="frm" action="listsiteinfo.shtml" method="post">

  <tr>
    <th height="22" colspan="8" class="tableHeaderText"><span class="STYLE1">类别列表 </span></th>
  </tr>
  <tr bgcolor="#FFFFFF" class="row_bottom">
    <td height="22" width="8%" align="center"><strong><a href="#" onClick=buildmore();>发布选中</a></strong></td>
    <td height="22" align="center" width="36%"><strong>标题</strong></td>
    <td align="center" width="11%"><a href="#" onClick="if(window.confirm('你确定发布列表页吗')) this.href='buildlisthtml.shtml/>';"><B>发布列表</B></a></td>
    ...
    <td width="10%" align="center"><strong><a href="new.jsp">添加</a></strong></td>
...
<logic:iterate id="infolist" name="clInfos">
  <tr bgcolor="#FFFFFF" height="25"  onMouseOver="this.bgColor='#ced7f7';" onMouseOut="this.bgColor='#FFFFFF';">
	...
	<a href="#" onClick="if(window.confirm('你确定发布该文章吗')) this.href='buildhtml.shtml?id=<bean:write name="infolist" property="id"/>&type=<bean:write name="infolist" property="filetype"/>';">发布</a></td>
	...
	<a href="#" onClick="if(window.confirm('你确定审核吗')) this.href='viewinfo.shtml?id=<bean:write name="infolist" property="id"/>&type=<bean:write name="infolist" property="filetype"/>';"><font color="#FF0000">审核</font></a>	</logic:notEqual>
	<logic:equal name="infolist" property="remark" value="1">
	<a href="#" onClick="if(window.confirm('你要取消审核吗')) this.href='viewnotinfo.shtml?id=<bean:write name="infolist" property="id"/>&type=<bean:write name="infolist" property="filetype"/>';">取消</a>	</logic:equal>	</td>
    <td align="center">&nbsp;<a href="edit.jsp">编辑</a></td>
    <td align="center">&nbsp;
	<a href="#" onClick="if(window.confirm('你确定删除吗')) this.href='deletesiteinfo.shtml?id=<bean:write name="infolist" property="id"/>&type=<bean:write name="infolist" property="filetype"/>';">删除</a></td>
  </tr>
 </logic:iterate>
 </logic:present>
...
<tr  bgcolor="#FFFFFF"  height="25">
    <td width="8%" height="25" align="center"><strong><a href="#" onClick=b()>全选</a></strong></td>
