...
String info_type="";	
if(request.getAttribute("infotype")!=null&&!request.getAttribute("infotype").equals("")){
	info_type = (String)request.getAttribute("infotype");
}
response.setStatus(301);
response.setHeader("Location", "html/"+info_type+"/index.html");
response.setHeader("Connection","close");
%>	
<html>
<head>
<base href="<%=basePath%>">
<meta name="keywords" content="<bean:write name="listtype" property="name"/>">
<meta name="description" content="<bean:write name="listtype" property="name"/>">
<title><bean:write name="listtype" property="name"/>-海乐网</title>
		...
		<div id="body_article" align="left">
			...
			<div id="list_info">
				<div align="left" id="list_info_row_title">
						...
						<bean:write name="listtype" property="name"/>&nbsp; <span class="STYLE4">&gt;&gt;</span> 列表</span></li>
						<li class="STYLE4" id="list_info_row_content_title_right">众深文化传播</li>
				</div>
...
%>
			...
			<html:link action="/articleList.shtml?pageMethod=first" name="map">首页</html:link>
			<html:link action="/articleList.shtml?pageMethod=previous" name="map">上一页</html:link>
			<html:link action="/articleList.shtml?pageMethod=next" name="map">下一页</html:link>
			<html:link action="/articleList.shtml?pageMethod=last" name="map">尾页</html:link>
				</li>
				<li style="text-align:center; list-style:none" class="STYLE9 STYLE14">
				<!-----广告信息------>
				</li>
			...
			<img src="image/hb666.gif" height="70" width="670px">
			</div>
