...
<title>${article.title}|${sitetype.name}|θվ/θҳ׆ط½̳ʭº£Vθ</title>
...
<div id="daohang">
	<li class="LiNoPointSearch" style="border:none">8Ŀµ¼º½£º</li>
	<li class="Lidaohang">
	<a href="../../index.html" target="_self">º£Vθ׷ҳ</a> >> 
	</li>
	<li class="Lidaohang">
	<a href="index.html" target="_self">${sitetype.name}</a> >> 
	</li>
	<li class="Lidaohang">
	${article.title}
	</li>
		...
		<div id="body_article" align="left">
			...
			<div id="view_info">
				...
				<li id="view_title_remark">
					4Դ£º<#if article.source_link!=""><a href="${article.source_link}"></#if>${article.source}</a>
					&nbsp;&nbsp;&nbsp;&nbsp;ط֟£º${article.author}
					&nbsp;&nbsp;&nbsp;&nbsp;ʱ¼䣺${article.date_created?string('yyyy-MM-dd HH:mm:ss')}
					&nbsp;&nbsp;&nbsp;&nbsp;䰀A¿£º<font color="#999999"><span id="view_num"></span></font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="../../member/newarticle.jsp" target="_blank"><b><font color="#c4290a">ϒҪͶ¸㺯font></b></a> 
				</li>
				<li id="view_content">
				...
				<li  id="view_line">
					<span class="STYLE9"><span class="STYLE16">Р¹َŕ</span></span>
				</li>
<#list aboutnew as newabout>
				<li id="view_line_left"><img src="../../image/member_002.gif" border="0" align="absmiddle"/>
				<span class="STYLE17">
				<a href="../../html/${newabout.type}/${newabout.id}.html">${newabout.title}</a>
				</span>
				</li>
		...
		<div id="body_right" align="left">
			...
			<li id="right_info_row_title">&nbsp;&nbsp;&nbsp;&nbsp;<B>Ά¼�¢</B></li>
			...
			<div id="right_info_2">
			<li id="right_info_2_row_title">&nbsp;&nbsp;&nbsp;&nbsp;<b>¾«Ʒµ¼¶�/b> </li>
<#list infoshow as show>
			<li id="right_info_row">
			&nbsp;&nbsp;&nbsp; <span class="STYLE6">
			${show.date_created?string('dd ɕ')}</span> 
