...
<div id="kuang">
	...
	<html:form action="/newmemberarticle.shtml" method="post">
		<div id="member_register">
				...
				<li id="httplinks_row" style="margin-top:10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="absmiddle" src="../image/member_001.gif" border="0"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="newarticle.jsp" target="_self">发表新文章</a></li>
			...
			<div id="member_register_left" style="width:400px;border-top:solid 3px #AADD44;border-left:solid 3px #AADD44;border-right:solid 3px #AADD44;border-bottom:solid 3px #AADD44;">
				...
				<li id="httplinks_li">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;文章标题：
					<html:text property="title" style="width:350px;" />
				</li>
				<li id="httplinks_li">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;信息来源：
					<html:text property="source"  style="width:350px;"  />
				</li>
				<li id="httplinks_li">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;来源链接：
					<html:text property="source_link"  style="width:350px;"  /> &nbsp;&nbsp;&nbsp;&nbsp;完整URL如：http://www.sealee.com</li>
				<li id="httplinks_li">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;文章作者：
					<html:text property="author" value="<%=membername%>" readonly="true"/>
				</li>
				...
				<li id="httplinks_li">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;详细内容：<br>
					<html:textarea property="content" styleId="content" style="width:0px; height:1px" /><iframe name="eWebEditor1" id="eWebEditor1" src="../editor/eWebEditor.jsp?id=content&style=standard" frameborder="0" scrolling="no" width="100%" height="500"></iframe>
				</li>
