...
<div id="kuang">
	...
	<div align="center">
		<div id="member_register">
			<html:form action="/memberlogin.shtml" method="post" onsubmit="check();">
			<div id="member_register_left">
				...
				<li id="member_register_row"> 验 证 码：<html:text property="checknum" style=" width:120px;"/>  <img id="img1" src="image.jsp" border="0" onClick="reloadImage()">&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000"></font></li>
