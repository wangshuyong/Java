...
{
  var truthBeTold = window.confirm("确定要发布通知吗？");
      if (truthBeTold)
       {
          return true;
       }
...
<TR>
	<TD>编辑内容：</TD>
	<TD>
		<INPUT type="hidden" name="content1" value="<p>&nbsp;</p><p><font color=#ff0000>本样式为自带默认样式，最佳调用宽度550px，高度350px！</font></p><p>下面为一些高级调用功能的例子，你可以用脚本方便的编辑进行一些操作。</p><p>看到这些内容，且没有错误提示，说明安装已经正确完成！</p>">
		<IFRAME ID="eWebEditor1" src="eWebEditor.jsp?id=content1&style=standard" frameborder="0" scrolling="no" width="640" height="350"></IFRAME>
	</TD>
</TR>
<TR>
	<TD colspan=2 align=right>
	<INPUT type=submit name=b1  onclick="return submitcheck()" value="提交">
